...
import (
	...
	"github.com/hello2mao/go-common/incubator/csp/signer"
	"github.com/hello2mao/go-common/incubator/csp/sw/mocks"
	"github.com/hello2mao/go-common/incubator/csp/utils"
...
func (tc testConfig) Provider(t *testing.T) (csp.CSP, csp.KeyStore, func()) {
...
func TestMain(m *testing.M) {
	...
	var err error
	tempDir, err = ioutil.TempDir("", "csp-sw")
	if err != nil {
...
func TestKeyGenECDSAOpts(t *testing.T) {
	...
	// Curve P256
	k, err := provider.KeyGen(&csp.ECDSAP256KeyGenOpts{Temporary: false})
	if err != nil {
	...
	// Curve P384
	k, err = provider.KeyGen(&csp.ECDSAP384KeyGenOpts{Temporary: false})
	if err != nil {
...
func TestKeyGenAESOpts(t *testing.T) {
	...
	// AES 128
	k, err := provider.KeyGen(&csp.AES128KeyGenOpts{Temporary: false})
	if err != nil {
	...
	// AES 192
	k, err = provider.KeyGen(&csp.AES192KeyGenOpts{Temporary: false})
	if err != nil {
	...
	// AES 256
	k, err = provider.KeyGen(&csp.AES256KeyGenOpts{Temporary: false})
	if err != nil {
...
func TestECDSAKeyGenEphemeral(t *testing.T) {
	...
	k, err := provider.KeyGen(&csp.ECDSAKeyGenOpts{Temporary: true})
	if err != nil {
...
func TestECDSAPrivateKeySKI(t *testing.T) {
	...
	k, err := provider.KeyGen(&csp.ECDSAKeyGenOpts{Temporary: false})
	if err != nil {
		t.Fatalf("Failed generating ECDSA key [%s]", err)
	}
...
func TestECDSAKeyReRand(t *testing.T) {
	...
	reRandomizedKey, err := provider.KeyDeriv(k, &csp.ECDSAReRandKeyOpts{Temporary: false, Expansion: []byte{1}})
	if err != nil {
	...
	reRandomizedKey2, err := provider.KeyDeriv(k2, &csp.ECDSAReRandKeyOpts{Temporary: false, Expansion: []byte{1}})
	if err != nil {
		t.Fatalf("Failed re-randomizing ECDSA key [%s]", err)
	}
...
func TestECDSASign(t *testing.T) {
	...
	digest, err := provider.Hash(msg, &csp.SHAOpts{})
	if err != nil {
...
func TestECDSAKeyImportFromExportedKey(t *testing.T) {
	...
	pk2, err := provider.KeyImport(pkRaw, &csp.ECDSAPKIXPublicKeyImportOpts{Temporary: false})
	if err != nil {
		t.Fatalf("Failed importing ECDSA public key [%s]", err)
	}
	if pk2 == nil {
		t.Fatal("Failed importing ECDSA public key. Return CSP key cannot be nil.")
	}
...
func TestECDSAKeyImportFromECDSAPublicKey(t *testing.T) {
	...
	pk2, err := provider.KeyImport(pub, &csp.ECDSAGoPublicKeyImportOpts{Temporary: false})
	if err != nil {
		t.Fatalf("Failed importing ECDSA public key [%s]", err)
	}
	if pk2 == nil {
...
func TestECDSAKeyImportFromECDSAPrivateKey(t *testing.T) {
	...
	sk, err := provider.KeyImport(priv, &csp.ECDSAPrivateKeyImportOpts{Temporary: false})
	if err != nil {
		t.Fatalf("Failed importing ECDSA private key [%s]", err)
	}
	if sk == nil {
		t.Fatal("Failed importing ECDSA private key. Return CSP key cannot be nil.")
	}
	...
	pk, err := provider.KeyImport(pub, &csp.ECDSAPKIXPublicKeyImportOpts{Temporary: false})
...
func TestKeyImportFromX509ECDSAPublicKey(t *testing.T) {
	...
	pk2, err := provider.KeyImport(cert, &csp.X509PublicKeyImportOpts{Temporary: false})
...
func TestAESKeyGen(t *testing.T) {
	...
	k, err := provider.KeyGen(&csp.AESKeyGenOpts{Temporary: false})
	if err != nil {
...
func TestAESEncrypt(t *testing.T) {
	...
	ct, err := provider.Encrypt(k, []byte("Hello World"), &csp.AESCBCPKCS7ModeOpts{})
	if err != nil {
...
func TestAESDecrypt(t *testing.T) {
	...
	ct, err := provider.Encrypt(k, msg, &csp.AESCBCPKCS7ModeOpts{})
	if err != nil {
		t.Fatalf("Failed encrypting [%s]", err)
	}

	pt, err := provider.Decrypt(k, ct, csp.AESCBCPKCS7ModeOpts{})
	if err != nil {
...
func TestHMACTruncated256KeyDerivOverAES256Key(t *testing.T) {
	...
	hmcaedKey, err := provider.KeyDeriv(k, &csp.HMACTruncated256AESDeriveKeyOpts{Temporary: false, Arg: []byte{1}})
	if err != nil {
	...
	ct, err := provider.Encrypt(hmcaedKey, msg, &csp.AESCBCPKCS7ModeOpts{})
	if err != nil {
		t.Fatalf("Failed encrypting [%s]", err)
	}

	pt, err := provider.Decrypt(hmcaedKey, ct, csp.AESCBCPKCS7ModeOpts{})
	if err != nil {
		t.Fatalf("Failed decrypting [%s]", err)
	}
	if len(ct) == 0 {
...
func TestHMACKeyDerivOverAES256Key(t *testing.T) {
	...
	hmcaedKey, err := provider.KeyDeriv(k, &csp.HMACDeriveKeyOpts{Temporary: false, Arg: []byte{1}})
...
func TestAES256KeyImport(t *testing.T) {
	...
	k, err := provider.KeyImport(raw, &csp.AES256ImportKeyOpts{Temporary: false})
	if err != nil {
...
func TestAES256KeyImportBadPaths(t *testing.T) {
	...
	_, err := provider.KeyImport(nil, &csp.AES256ImportKeyOpts{Temporary: false})
	if err == nil {
		t.Fatal("Failed importing key. Must fail on importing nil key")
	}

	_, err = provider.KeyImport([]byte{1}, &csp.AES256ImportKeyOpts{Temporary: false})
	if err == nil {
...
func TestSHA(t *testing.T) {
	...
	for i := 0; i < 100; i++ {
		...
		h1, err := provider.Hash(b, &csp.SHAOpts{})
		if err != nil {
