...
func (kd *ecdsaPublicKeyKeyDeriver) KeyDeriv(key csp.Key, opts csp.KeyDerivOpts) (csp.Key, error) {
	// Validate opts
	if opts == nil {
	...
	reRandOpts, ok := opts.(*csp.ECDSAReRandKeyOpts)
	if !ok {
...
func (kd *ecdsaPrivateKeyKeyDeriver) KeyDeriv(key csp.Key, opts csp.KeyDerivOpts) (csp.Key, error) {
	// Validate opts
	if opts == nil {
		return nil, errors.New("Invalid opts parameter. It must not be nil.")
	}
...
func (kd *aesPrivateKeyKeyDeriver) KeyDeriv(k csp.Key, opts csp.KeyDerivOpts) (csp.Key, error) {
	// Validate opts
	if opts == nil {
		return nil, errors.New("Invalid opts parameter. It must not be nil.")
	}
	...
	case *csp.HMACTruncated256AESDeriveKeyOpts:
