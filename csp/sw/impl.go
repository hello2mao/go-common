...
// CSP provides a generic implementation of the CSP interface based
...
func New(keyStore csp.KeyStore) (*CSP, error) {
	if keyStore == nil {
		return nil, errors.Errorf("Invalid csp.KeyStore instance. It must be different from nil.")
	}
